...
var best_winning_turn = number_of_turns
var best_score = 0
...
while readLine() != nil {
    ...
    if winning_turn <= best_winning_turn {
        var score = 0
        for row in 0...4 {
            for col in 0...4 {
                let value = board[row][col]
        ...
        best_winning_turn = winning_turn
        best_score = score
    }
}

print("Best board won on turn \(best_winning_turn) (counting from 0)")
print("Score of the winning board: \(best_score)")
